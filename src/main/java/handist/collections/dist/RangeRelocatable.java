...
public interface RangeRelocatable<R> {
     ...
     * transfer will be performed when the {@link MoveManagerLocal#sync()} method of
     * the provided manager is called
     *
     ...
     */
    public default void moveRangeAtSync(Collection<R> ranges, RangedDistribution<R> destination,
     ...
     * will be performed when the {@link MoveManagerLocal#sync()} method is called.
     *
