...
public interface ParallelReceiver<T> {
	/**
	 * Provides a new handle that will place T instances into this instance. 
	 * This method may be called by multiple threads that all want to place some
	 * instances into this object. The implementation guarantees that all these
	 * threads will be able to place T instances in this object through the 
	 * returned {@link Consumer} without blocking or otherwise contend for 
	 * object access with other threads.
	 * 
